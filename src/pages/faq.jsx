            ...
            <div className="row">
              <div className="accordion_wrap col-md-8 offset-md-2 col-sm-12">
                ...
                <div className="accordion">
                  ...
                  <div className="content">I'd like to demonstrate a powerful little pattern called “Server-Fetched Partials” that offers some tangible benefits over alternatives like VueJS for simple page interactions.</div>
                </div>
                <div className="accordion">
                  <div className="accordion__title">
                    <h2>
